    ...
    <table>
        ...
        while ($infos = $invoices->fetch(PDO::FETCH_ASSOC)) {
            ...
            <tr class='line'>
                ...
                <td>
                  <a href='index.php?action=update_invoice&id=" . $id . "'><img src='./assets/img/edit.png' /></a>
                  <a href='index.php?action=delete_invoice&id=" . $id . "'><img src='./assets/img/delete.png' /></a>
                </td>
            </tr>
    ";
        }
    ...
    <table>
        ...
        while ($infos = $contacts->fetch(PDO::FETCH_ASSOC)) {
            ...
            <tr class='line'>
                ...
                <td>
                  <a href='index.php?action=update_contact&id=" . $id . "'><img src='./assets/img/edit.png' /></a>
                  <a href='index.php?action=delete_contact&id=" . $id . "'><img src='./assets/img/delete.png' /></a>
                </td>
            </tr>
    ";
        }
...
while ($infos = $companies->fetch(PDO::FETCH_ASSOC)) {
    ...
    echo "
            <tr class='line'>
                ...
                <td>
                  <a href='index.php?action=update_company&id=" . $id . "'><img src='./assets/img/edit.png' /></a>
                  <a href='index.php?action=delete_company&id=" . $id . "'><img src='./assets/img/delete.png' /></a>
                </td>                
            </tr>
    ";
}
